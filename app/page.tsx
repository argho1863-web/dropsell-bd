...
function HomeContent() {
  ...
  return (
    <div>
      {banner && (
        <div style={{background:banner.type==="approved"?"#16a34a":"#ef4444",color:"white",padding:"16px",textAlign:"center",position:"relative"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"10px",flexWrap:"wrap"}}>
            {banner.type === "approved" ? <CheckCircle size={20} /> : <XCircle size={20} />}
          ...
          <button onClick={() => setBanner(null)} style={{position:"absolute",right:"16px",top:"50%",transform:"translateY(-50%)",background:"transparent",border:"none",color:"white",cursor:"pointer"}}>
            <X size={18} />
          </button>
        </div>
      )}

      <section style={{background:"linear-gradient(135deg, #15803d, #16a34a, #22c55e)",color:"white",padding:"64px 16px",overflow:"hidden"}}>
        <div style={{maxWidth:"1200px",margin:"0 auto"}}>
          <div style={{maxWidth:"600px"}}>
            <div style={{display:"inline-flex",alignItems:"center",gap:"8px",background:"rgba(255,255,255,0.2)",borderRadius:"99px",padding:"6px 16px",fontSize:"13px",marginBottom:"20px",border:"1px solid rgba(255,255,255,0.3)"}}>
              ...
              Probaho — Bangladesh&apos;s Trusted Marketplace
            </div>
        ...
        <div style={{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"8px",marginBottom:"20px"}}>
          {CATEGORIES.map((cat) => (
            <button
              ...
              style={{flexShrink:0,padding:"8px 16px",borderRadius:"10px",fontSize:"13px",fontWeight:"600",cursor:"pointer",border:"none",textTransform:"capitalize",background:activeCategory===cat?"#16a34a":"white",color:activeCategory===cat?"white":"#6b7280",boxShadow:activeCategory===cat?"0 2px 8px rgba(22,163,74,0.3)":"0 1px 3px rgba(0,0,0,0.1)"}}
            >
